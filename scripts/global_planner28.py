...
class GlobalPlanner:
	...
	def __init__(self):
		...
		self.tf = rospy.get_param("final_time", 15.0)   #final time
...
#	rospy.Subscriber("amcl_pose2",Pose,self.robot_pose_callback);
	...
	def robot_pose_callback(self, msg):
		...
		self.robot_pose = 1;
		rospy.loginfo("initial position of the robot = [x=%f y=%f th=%f]",msg.pose.pose.position.x,msg.pose.pose.position.y,self.k0);   
		return
	def move_robot(self):
